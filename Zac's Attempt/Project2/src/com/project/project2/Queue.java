...
public class Queue {
    ...
    public Queue(int Numclerks, int linelength) {
        ...
        for (j = 0; j < Numclerks; j++) {
            //Clerk[j] =  1;
            this.Items = new int[linelength];
            for (i = 0; i < linelength; i++) {

                Random rand = new Random();
                int items = rand.nextInt(4) + 2;
                Items[i] = items;
                count = linelength;
                //Items[j] = items;
